        ...
        <div>
            ...
            <div className="relative">
                <div className="lg:grid grid-cols-12 gap-5 ">
                    <div className="col-span-4 lg:w-full h-[400px] sm:w-[90%] sm:m-auto sm:mb-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer" data-aos="fade-up">
                        ...
                        <div className="m-3 space-y-3">
                            <div className="lg:w-full h-[93px] bg-gray-50 rounded-xl p-3 hover:bg-[#f0f0f4] transition-all duration-300">
                    ...
                    <div className="col-span-4 w-full h-[400px] sm:w-[90%] sm:m-auto sm:mb-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer" data-aos="fade-up">
                        <div className="lg:w-full h-[170px] relative rounded-t-2xl overflow-hidden bg-gradient-to-br from-[#2558fa] to-[#6d13e9] p-6 ">
                    ...
                    <div className="col-span-4 w-full h-[400px] sm:w-[90%] sm:m-auto sm:mb-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer" data-aos="fade-up">
                        <div className="lg:w-full h-[170px] relative rounded-t-2xl overflow-hidden bg-gradient-to-br from-[#fd1d5b] to-[#9d0b9a] p-6 ">
                            <div className="absolute -left-3 -bottom-3 w-[70px] h-[70px] rounded-full bg-[#cc006b]"></div>
