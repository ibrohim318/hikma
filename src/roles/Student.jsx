    ...
    return (
        <div>
            <center className="my-8 flex items-center justify-center gap-2">
                ...
                <h3 className="text-blue-700 font-semibold">Fikrlash va tafakkur - ilmning asosi!</h3>
            </center>
            <div className="relative">
                <div className="grid grid-cols-12 gap-5 ">
                    <div className="col-span-4 w-full h-[340px] rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer" data-aos="fade-up">
                        <div className="w-full h-[120px] relative rounded-t-2xl overflow-hidden bg-gradient-to-br from-blue-400 to-indigo-700 p-6 text-white">
                            ...
                            <div className="relative z-10 flex items-center  gap-3">
                                <div className="w-[45px] h-[45px] rounded-lg border-2 boroder-white bg-blue-400 flex items-center justify-center">
                                    <LuBrain size={25} className="text-white" />
                                </div>
                                <div>
                                    <h3 className="text-white text-lg font-semibold mt-3">Fikrlash</h3>
                        ...
                        <div className="m-3 space-y-3">
                            <div className="w-full h-[93px] bg-gray-50 rounded-xl p-3 hover:bg-[#f0f0f4] transition-all duration-300">
                                <div className="flex items-start gap-3 ">
                                    ...
                                    <div>
                                        <h1 className="text-md font-medium">Fikrlashning opearasion sistemasi</h1>
                    ...
                    <div className="col-span-4 w-full h-[340px] rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer" data-aos="fade-up">
                        <div className="w-full h-[120px] relative rounded-t-2xl overflow-hidden bg-gradient-to-br from-purple-500 to-indigo-700 p-6 ">
                            ...
                            <div className="relative z-10 flex items-center  gap-3">
                                <div className="w-[45px] h-[45px] rounded-lg bg-purple-600 flex items-center border-2 boroder-white justify-center">
                                    <GoBook size={25} className="text-white" />
                                </div>
                                <div>
                                    <h3 className="text-white text-lg font-semibold mt-3">Ta'lim</h3>
                    ...
                    <div className="col-span-4 w-full h-[340px] rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer" data-aos="fade-up">
                        <div className="w-full h-[120px] relative rounded-t-2xl overflow-hidden bg-gradient-to-br from-orange-600 to-yellow-400 p-6 text-white">
                            ...
                            <div className="relative z-10 flex items-center gap-3">
                                <div className="w-[45px] h-[45px] rounded-lg bg-yellow-400 border-2 boroder-white flex items-center justify-center">
                                    <LuLeaf size={25} className="text-white" />
                                </div>
                                <div>
                                    <h3 className="text-white text-lg font-semibold mt-3">Qadriyatlar va shaxsiy rivojlanish</h3>
